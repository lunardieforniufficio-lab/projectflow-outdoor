-- =============================================
-- ProjectFlow — Seed Data Iniziali
-- Eseguire DOPO 001-schema.sql
-- =============================================
...
-- === UTENTI GESTIONALE (clerk_user_id placeholder) ===
...
ON CONFLICT (stato_da_id, stato_a_id) DO NOTHING;
...
ON CONFLICT (ruolo_id, sezione, azione) DO NOTHING;
